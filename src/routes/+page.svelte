		...
		<div class="tentang-grid">
			...
			<div class="tentang-content">
				...
				<p class="tentang-text">
					...
					sebagai pembentuk karakter pelajar Indonesia. Sejak 2025, kami telah
...
<style>
	...
	.countdown-wrap { display: inline-flex; flex-direction: column; gap: 10px; }
	.countdown-label {
	...
	.countdown-val  { font-family: var(--font-mono); font-size: var(--text-2xl); font-weight: 600; color: white; line-height: 1; }
	.countdown-unit { font-size: var(--text-xs); color: rgba(255,255,255,0.45); margin-top: 4px; }
	.countdown-sep  { font-size: var(--text-2xl); color: rgba(255,255,255,0.3); font-weight: 300; margin-bottom: 12px; }
	...
	.stats-inner { display: flex; justify-content: space-around; padding: 24px 0; }
	.stat-item   { display: flex; flex-direction: column; align-items: center; gap: 4px; }
	.stat-value  { font-size: var(--text-3xl); font-weight: 700; color: white; letter-spacing: -0.02em; line-height: 1; }
	.stat-label  { font-size: var(--text-xs); color: rgba(255,255,255,0.45); text-transform: uppercase; letter-spacing: 0.06em; }
	...
	.section-title { font-size: clamp(1.75rem, 4vw, 2.5rem); color: var(--color-black); margin-bottom: 16px; }
	.section-desc  { font-size: var(--text-lg); color: var(--color-gray-500); max-width: 560px; margin: 0 auto; line-height: 1.7; }

	.keunggulan-grid { display: grid; grid-template-columns: 1fr; gap: 20px; }
	@media (min-width: 768px) { .keunggulan-grid { grid-template-columns: repeat(3, 1fr); } }
	.keunggulan-card  { text-align: center; }
	.keunggulan-icon  { width: 56px; height: 56px; border-radius: var(--radius-lg); display: inline-flex; align-items: center; justify-content: center; font-size: 26px; margin-bottom: 16px; }
	...
	.keunggulan-title { font-size: var(--text-xl); font-weight: 700; color: var(--color-black); margin-bottom: 10px; }
	.keunggulan-desc  { font-size: var(--text-base); color: var(--color-gray-500); line-height: 1.7; }

	.tentang-grid { display: grid; grid-template-columns: 1fr; gap: 48px; align-items: center; }
	...
	.tentang-text       { color: var(--color-gray-700); line-height: 1.75; margin-bottom: 16px; }
	.tentang-highlights { margin-top: 24px; display: flex; flex-direction: column; gap: 12px; }
	.highlight-item     { display: flex; align-items: center; gap: 12px; font-size: var(--text-base); color: var(--color-gray-700); }
	.highlight-icon     { width: 24px; height: 24px; border-radius: var(--radius-full); display: inline-flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 700; flex-shrink: 0; }

	.juri-grid { display: grid; grid-template-columns: 1fr; gap: 20px; }
	...
	.juri-nama { font-size: var(--text-base); font-weight: 700; color: var(--color-black); margin-bottom: 8px; }

	.cta-section { background: var(--color-black); padding: 80px 0; }
	.cta-content { text-align: center; }
	.cta-title   { font-size: clamp(2rem, 5vw, 3.5rem); color: white; margin-bottom: 16px; }
	.cta-desc    { font-size: var(--text-lg); color: rgba(255,255,255,0.6); max-width: 520px; margin: 0 auto 36px; line-height: 1.7; }
	.cta-actions { display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; }

	.footer       { background: var(--color-white); border-top: 1px solid var(--color-gray-200); padding: 32px 0; }
	.footer-inner { display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 16px; }
	.footer-brand { display: flex; flex-direction: column; gap: 4px; }
	.footer-logo  { display: flex; align-items: center; gap: 8px; }
	.logo-mark    { width: 32px; height: 32px; background: var(--color-primary); color: white; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-family: var(--font-display); font-size: 18px; }
